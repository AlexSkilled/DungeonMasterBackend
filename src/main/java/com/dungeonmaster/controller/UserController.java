    ...
    public ResponseEntity<?> addUser(@RequestBody UserDTO dto) {
    	...
    	try {
    		...
    		case UserAlreadyExists:
    			return new ResponseEntity<>(new String("Пользователь уже существует."), HttpStatus.OK);
    		case InvalidEmail:
    			return new ResponseEntity<>(new String("Неверный формат Email"), HttpStatus.OK);
    		case InvalidName:
    			return new ResponseEntity<>(new String("Неверный формат имени"), HttpStatus.OK);
    		}
    	}
